...
const Login = () => {
    const { userLogin, singInWithGoogle, signInWithGit } = useContext(AuthContext);
    ...
    return (
        <div className='lg:w-[450px] mx-auto lg:pt-10'>
            ...
            <div className='lg:w-[370px] p-4 lg:flex justify-between'>
                ...
                <button onClick={githubLogin} className='btn flex items-center py-2 px-4 bg-[#8DC63F] text-white hover:bg-white hover:text-black rounded-full'> <span className='pr-2'><FaGithub></FaGithub></span>With Github</button>
            </div>
        </div>
    );
};
